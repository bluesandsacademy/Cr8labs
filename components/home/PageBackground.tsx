...
/**
 * The one background for every page. It is position: fixed and never
 * scrolls: content arrives over a world that holds still. The rings, glow
 * and grain never move.
 *
...
export function PageBackground() {
  ...
  return (
    <div className="fixed inset-0 z-0 overflow-hidden bg-adire-dark" aria-hidden="true">
      {/* The world's resting glow, present from the first frame on every page. */}
      <div
        className="absolute inset-0"
        style={{
          background:
            "radial-gradient(circle at 50% 48%, rgba(255,235,89,0.28) 0%, rgba(44,39,108,0.6) 40%, rgba(23,19,15,0.98) 78%)",
        }}
      />
      ...
      <div ref={inkRef} className="absolute inset-0 bg-ink opacity-0">
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(255,235,89,0.14) 0%, rgba(255,235,89,0) 60%)",
          }}
        />
