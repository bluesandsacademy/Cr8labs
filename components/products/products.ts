 ...
 * rendered. Calls to action go to the contact page until product pages
 * exist; a funder's click should never land on a 404.
 */
export const PRODUCTS: Product[] = [
  {
    ...
    whoFor: "Nursery and primary schools, homeschooling families, libraries, STEM clubs and publishers licensing the format.",
    keyPoints: [
  ...
  },
  {
    ...
    whoFor: "Publishers, museums, brands, agencies, event organisers and government campaigns.",
    keyPoints: [
  ...
  },
  {
    ...
    whoFor: "Secondary schools, universities, technical and vocational training, healthcare training, museums and tourism.",
    keyPoints: [
  ...
  },
  {
    ...
    whoFor: "Secondary schools, science centres, ministries of education and NGO programmes.",
    keyPoints: [
  ...
  },
  {
    ...
    whoFor: "Schools running the platform, and families using the individual subscription.",
    keyPoints: [
  ...
  },
  {
    ...
    whoFor: "Teachers, curriculum leads, training managers and publishers.",
    keyPoints: [
  ...
  },
  {
    ...
    whoFor: "Upper primary and secondary students, STEM clubs, holiday programmes and competitions.",
    keyPoints: [
  ...
  },
  {
    ...
    whoFor: "Every product above, plus publishers and studios who licence assets directly.",
    keyPoints: [
